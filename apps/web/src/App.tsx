    ...
    <div className="modal-overlay print-modal-overlay" onClick={onClose} style={{ zIndex: 9999 }}>
      ...
      >
        ...
        <div className="official-pdf-document" style={{ color: "#0f172a", fontFamily: "var(--font-body)", background: "#ffffff", padding: "24px", borderRadius: "var(--radius-sm)", border: "1px solid var(--border-light)" }}>
          ...
          {/* ==================== PAGE 1 : SYNTHÈSE GLOBALE & SIGNATURES ==================== */}
          <div style={{ pageBreakAfter: "always", breakAfter: "page", minHeight: "850px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            <div>
              {/* ENTÊTE DU PV */}
            ...
            <div style={{ marginTop: "auto", borderTop: "2px solid #0f172a", paddingTop: "20px" }}>
          ...
          {dataset.classrooms.map((c) => {
            ...
            return (
              <div key={c.id} className="pdf-page-class" style={{ breakBefore: "page", pageBreakBefore: "always", pageBreakInside: "avoid", breakInside: "avoid", paddingTop: "10px" }}>
